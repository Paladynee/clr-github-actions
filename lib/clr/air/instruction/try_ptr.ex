defmodule Clr.Air.Instruction.TryPtr do
  ...
  Pegasus.parser_from_string(
    """
    try_ptr <- 'try_ptr' lparen slotref cs type cs codeblock_clobbers (space clobbers)? rparen
    """,
    try_ptr: [export: true, post_traverse: :try_ptr]
  )

  defp try_ptr(rest, [{:clobbers, clobbers}, code, type, loc, "try_ptr"], context, _slot, _bytes) do
