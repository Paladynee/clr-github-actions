defmodule Clr.Air.Instruction.CondBr do
  ...
  Clr.Air.import(~w[slotref cs space lparen rparen type codeblock_clobbers]a)
  ...
  def cond_br(
    ...
    {rest, [%__MODULE__{cond: slotref, true_branch: true_branch, false_branch: false_branch}],
     context}
  end
end
